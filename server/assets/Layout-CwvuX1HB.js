...
function PageHero({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 gradient-mesh opacity-70" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-32 -right-32 w-96 h-96 rounded-full bg-primary-glow/30 blur-3xl animate-blob" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-primary/20 blur-3xl animate-blob", style: { animationDelay: "3s" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-6 pt-20 pb-16 md:pt-28 md:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeIn, { children: [
      eyebrow && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium glass-card text-primary mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary animate-pulse" }),
        eyebrow
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl font-bold leading-[1.05] max-w-4xl", children: title }),
...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: `mx-auto max-w-7xl px-6 py-16 md:py-24 ${className}`, children });
}
function SectionHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeIn, { className: center ? "text-center max-w-3xl mx-auto mb-12" : "max-w-3xl mb-12", children: [
    eyebrow && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-[0.2em] uppercase text-primary mb-3", children: eyebrow }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold leading-tight", children: title }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground leading-relaxed", children: subtitle })
  ] });
}
export {
  Counter as C,
